package io.github.Theray070696.tiersystem.network;
...
import io.github.Theray070696.tiersystem.network.packet.AbstractPacket;
...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket>
{
    ...
    public boolean registerPacket(Class<? extends AbstractPacket> clazz)
    {
        ...
        {
            LogHelper.fatal("Packet ID too large!");
            return false;
        }

        if(this.packets.contains(clazz))
        {
            LogHelper.fatal("Packet already registered!");
            return false;
        }

        if(this.isPostInitialized)
        {
            LogHelper.fatal("Packet was registered too late!");
            return false;
        }
    ...
    {
        this.registerPacket(PacketSyncTiers.class);
        this.registerPacket(PacketSendServerConfigs.class);
        this.registerPacket(PacketSyncItems.class);
    }
}